...
public class TestDatabase {
    ...
    @Test
    void removeUserAnime() {
        AddAnimeToDbRepository addAnimeToDbRepository = new AddAnimeToDbRepositoryImpl();
        boolean result = addAnimeToDbRepository.removeDatabaseAnimeUserById(9969);
        System.out.println("log " + result);
    }
    ...
    void testAja() {
        AddAnimeToDbRepository addAnimeToDbRepository = new AddAnimeToDbRepositoryImpl();
//        List<Anime> animeList = addAnimeToDbRepository.joinAllAsyncResults(addAnimeToDbRepository.getAllAnimeListUserAsync());
        addAnimeToDbRepository.getAllAnimeListUserAsync().parallelStream().forEach(e -> {
            try {
                System.out.println(e.get().title);
                ImageIcon tes = ImageRenderer.createImageIconByURL(e.get().images.getJpg().largeImageUrl);
    ...
    void testLagi() {
        ...
        animeListWorker.execute(); // Eksekusi di luar EDT
